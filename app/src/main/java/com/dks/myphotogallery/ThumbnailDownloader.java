...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    ConcurrentMap<T, String> mRequestMap = new ConcurrentHashMap<>();
    ...
    public void queueThumbnail(T target, String url){
        ...
        if(url == null){
            ...
            mRequestHandler.obtainMessage(MASSAGE_DOWNLOAD, target)
                    .sendToTarget();
        }
    }
    public void clearQueue(){
        mResponseHandler.removeMessages(MASSAGE_DOWNLOAD);
    }
}
